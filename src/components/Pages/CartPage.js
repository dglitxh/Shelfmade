...
const CartPage = (props) => {
  const {user, items, totalPrice, changeQuantity, removeFromCart, emptyCart} = props
        ...
        <div className="lg:px-2 lg:w-1/2">
          ...
          <div className="p-4">
            <p className="mb-6 italic">Shipping and additionnal costs are calculated based on values you have entered</p>
              ...
              <Link to={!user? '/login': ''}>
                <button onClick={() => checkout(user.email, totalPrice, emptyCart)} className="flex justify-center w-full px-10 py-3 mt-6 font-medium text-white uppercase bg-gray-800 rounded-full shadow item-center hover:bg-gray-700 focus:shadow-outline focus:outline-none">
