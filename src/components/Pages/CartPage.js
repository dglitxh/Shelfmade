      ...
      <table class="w-full text-sm lg:text-base" cellspacing="0">
        ...
        return(  
          <tr>
            ...
            <button onClick={(e) => {changeQuantity(listItem.item.id, "subtract")}} class="text-gray-500 focus:outline-none focus:text-gray-600">
                 <svg class="h-5 w-5" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M15 12H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                </button>
                <span class="text-gray-700 mx-2">{listItem.quantity}</span>
                <button onClick={(e) => changeQuantity(listItem.item.id, "add")} class="text-gray-500 focus:outline-none focus:text-gray-600">
